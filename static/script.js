...
const GITHUB_USERNAME = 'pprunbot'; // 请修改为您的GitHub用户名
...
function detectDevTools() {
    ...
    function showDevToolsMessage() {
        ...
        console.log('%c👋 我的email：liyinan251@gmail.com', 'color: #00b894; font-size: 16px; font-weight: bold;');
        console.log('%c📧 联系我：https://t.me/wangye03', 'color: #fdcb6e; font-size: 14px;');
        console.log('%c🌟 GitHub：https://github.com/pprunbot', 'color: #e17055; font-size: 14px;');
